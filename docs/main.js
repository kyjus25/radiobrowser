...
var NewStationComponent = /** @class */ (function () {
    ...
    NewStationComponent.prototype.setCountryCode = function () {
...
var StationsComponent = /** @class */ (function () {
    ...
    StationsComponent.prototype.searchStations = function () {
        ...
        this.http.post('https://www.radio-browser.info/webservice/json/stations/search', searchParams).subscribe(function (res) {
            ...
            _this.pageChange({ first: 0, rows: 10 });
            _this.loading = false;
        ...
        var _loop_1 = function (i) {
            ...
            if (this_1.tableData[event.first + i]) {
                this_1.http.get('https://icy.radio-browser.live/icy.php?url=' + this_1.tableData[event.first + i].url)
                    ...
                    .subscribe(function (icy) {
                    if (icy && icy.hasOwnProperty('icy-title') && icy['icy-title'] !== '') {
                        _this.tableData[event.first + i].playing = icy['icy-title'];
                    }
                });
            }
        };
